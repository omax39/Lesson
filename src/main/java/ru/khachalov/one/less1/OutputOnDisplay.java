 ...
 * @version 1.0
 */
public final class OutputOnDisplay {
    ...
    public static class GUIConsoleIO {
        ...
        private void printText(String txt, SimpleAttributeSet attr) {
            try {
                ...
                OutputOnDisplay.io.println("Error occurred in printText");
                OutputOnDisplay.io.println(ex.getMessage());
            }
        }
